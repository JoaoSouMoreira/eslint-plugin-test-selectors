    ...
    configs: {
        recommended: {
            ...
            rules: {
                ...
                'test-selectors/radio': 'warn',
                'test-selectors/select': 'warn',
        ...
        recommendedWithErrors: {
            ...
            rules: {
                ...
                'test-selectors/radio': 'error',
                'test-selectors/select': 'error',
