...
module.exports = {
    ...
    shouldBypass: (node, options, rawTests, filename) => {
        ...
        // Ignore index.jsx files
        const shouldIgnoreIndexFiles = (typeof options.ignoreIndexFiles === 'boolean' && options.ignoreIndexFiles) ||
            (typeof options.ignoreIndexFiles === 'undefined' && defaults.ignoreIndexFiles);
        if (shouldIgnoreIndexFiles) {
