...
module.exports = {
    ...
    shouldBypass: (node, options, rawTests, filename) => {
        ...
        const ignoreFileName = (typeof options.ignoreFileName === 'string' && options.ignoreFileName) ||
            (typeof options.ignoreFileName === 'undefined' && defaults.ignoreFileName);
        if (ignoreFileName) {
            return filename !== ignoreFileName;
        }
